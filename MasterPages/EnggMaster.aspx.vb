...
Partial Class Bagalkot_MasterPages_EnggMaster
    ...
    Private Sub BindData()
        grdscheme.DataSource = _objAdminBll.Bgt_BindEngg
        grdscheme.DataBind()
    End Sub
    ...
    Private Sub SaveDetails()
        ...
        Try
            _objBgt.EnggName = txtSchemeName.Text


            If btnAdd.Text = "Add" Then
                _objBgt.EnggId = 0
                strMsg = "Added Successfully"
                iRes = _objAdminBll.Bgt_AddEngg(_objBgt)
            Else
                _objBgt.EnggId = Session("EnggId")
    ...
    Private Sub PopulateData(ByVal intRowIndex As Integer)
        Try
            ...
            Session("EnggId") = lblgrdSchemeCode.Text
