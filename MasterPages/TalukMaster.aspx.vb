...
Partial Class Bagalkot_MasterPages_TalukMaster
    ...
    Private Sub BindData()
        grdscheme.DataSource = _objAdminBll.Bgt_BindTaluk(7)
        grdscheme.DataBind()
    End Sub
    ...
    Private Sub SaveDetails()
        ...
        Try
            _objBgt.TalukName_Eng = txtSchemeName.Text
            _objBgt.TalukName_Kan = txtSchemeName_Kan.Text

            If btnAdd.Text = "Add" Then
                _objBgt.TalukCode = 0
                strMsg = "Added Successfully"
                iRes = _objAdminBll.Bgt_AddTaluk(_objBgt)
            Else
                _objBgt.TalukCode = Session("TalukCode")
    ...
    Private Sub PopulateData(ByVal intRowIndex As Integer)
        Try
            ...
            Session("TalukCode") = lblgrdSchemeCode.Text
