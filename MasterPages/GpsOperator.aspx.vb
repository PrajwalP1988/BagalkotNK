...
Partial Class Bagalkot_MasterPages_GpsOperator
    ...
    Private Sub BindData()
        grdscheme.DataSource = _objAdminBll.Bgt_BindGPSOperator
        grdscheme.DataBind()
    End Sub
    ...
    Private Sub SaveDetails()
        ...
        Try
            _objBgt.GPsOptName = txtSchemeName.Text
            IMEI = txtVIMEI.Text

            If btnAdd.Text = "Add" Then
                _objBgt.GPSOperator = 0
                strMsg = "Added Successfully"
                iRes = _objAdminBll.Bgt_AddGPS(_objBgt, IMEI)
            Else
                _objBgt.GPSOperator = Session("GPSOperator")
    ...
    Private Sub PopulateData(ByVal intRowIndex As Integer)
        Try
            ...
            Session("GPSOperator") = lblgrdSchemeCode.Text

            txtSchemeName.Text = CType(grdscheme.Rows(intRowIndex).FindControl("lblSchemeEng"), Label).Text
            txtVIMEI.Text = CType(grdscheme.Rows(intRowIndex).FindControl("lblvIMEI"), Label).Text
