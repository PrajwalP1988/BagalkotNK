...
Partial Class Bagalkot_MasterPages_DeptMaster
    ...
    Private Sub BindData()
        grdscheme.DataSource = _objAdminBll.Bgt_BindDepartment
        grdscheme.DataBind()
    End Sub
    ...
    Private Sub SaveDetails()
        ...
        Try
            _objBgt.DeptName_Eng = txtSchemeName.Text
            _objBgt.DeptName_Kan = txtSchemeName_Kan.Text

            If btnAdd.Text = "Add" Then
                _objBgt.DeptId = 0
                strMsg = "Added Successfully"
                iRes = _objAdminBll.Bgt_AddDept(_objBgt)
            Else
                _objBgt.DeptId = HiddenField1.Value
    ...
    Private Sub PopulateData(ByVal intRowIndex As Integer)
        Try
            ...
            ViewState("DeptCode") = lblgrdSchemeCode.Text
            HiddenField1.Value = lblgrdSchemeCode.Text
