<%@ Page Language="VB" MasterPageFile="~/SiteMaster/MasterPage.master" AutoEventWireup="false" CodeFile="SourceFundMaster.aspx.vb" Inherits="Bagalkot_MasterPages_SourceFundMaster" title="Untitled Page"  Theme="Koppal"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
        <h2 class="title">Source of Fund</h2>
...
<asp:TemplateField HeaderText="Source – English"><ItemTemplate>
                                <asp:Label ID="lblSchemeEng" runat="server" Text='<%#DataBinder.Eval(Container,"DataItem.vFundSource_Eng")%>' />
...
<asp:TemplateField HeaderText="Source - Kannada"><ItemTemplate>
                                <asp:Label ID="lblSchemeKan" runat="server" Text='<%#DataBinder.Eval(Container,"DataItem.vFundSource_Kan")%>' />
...
<asp:TemplateField Visible="False"><ItemTemplate>
                                <asp:Label ID="lblSchemeCode" runat="server" Text='<%#DataBinder.Eval(Container,"DataItem.vSourceID")%>' />
...
<ItemStyle Height="5%"></ItemStyle>
            ...
            <asp:Label id="lblSchemeName" runat="server" 
                Text="Source (English) :" Font-Names="Arial" Font-Size="11pt"></asp:Label> </TD><TD align=left>
        ...
        <asp:Label id="lblSchemeNameKan" runat="server" Text="Source(Kannada) :" 
            ...
            <asp:TextBox id="txtSchemeName_Kan" tabIndex=2 runat="server" 
                ...
                AutoCompleteType="disabled" Font-Size="11pt"></asp:TextBox> </TD></TR><TR><TD align=center colSpan=2>
