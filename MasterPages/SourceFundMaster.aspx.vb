...
Partial Class Bagalkot_MasterPages_SourceFundMaster
    ...
    Private Sub BindData()
        grdscheme.DataSource = _objAdminBll.Bgt_BindFundSource()
        grdscheme.DataBind()
    End Sub
    ...
    Private Sub SaveDetails()
        ...
        Try
            _objBgt.SourceName_Eng = txtSchemeName.Text
            _objBgt.SourceName_Kan = txtSchemeName_Kan.Text

            If btnAdd.Text = "Add" Then
                _objBgt.SourceId = 0
                strMsg = "Added Successfully"
                iRes = _objAdminBll.Bgt_AddSourceFund(_objBgt)
            Else
                _objBgt.SourceId = Session("SourceCode")
    ...
    Private Sub PopulateData(ByVal intRowIndex As Integer)
        Try
            ...
            Session("SourceCode") = lblgrdSchemeCode.Text
